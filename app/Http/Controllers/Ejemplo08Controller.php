...
/*
  ...
  Para ejecutarlo en el navagador: http://192.168.1.100:8000/ejemplo08
*/
...
class Ejemplo08Controller extends Controller
{
	/**
    ...
    {
       return View::make('pages.ejemplo08');
    }
}
